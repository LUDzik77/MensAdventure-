...
Saladin_Tuahihi_skills = [("Lowkick", 1), ("Devastating overhand", 10), ("Powerjab", 5), ("Bearhug takedown", 10),\
                                ("Brute force sweep", 1), ("Roar naked choke",10), ("1-2-kick combo",10), ("Jab",1), ("Devastating overhand",100000)]
Saladin_Tuahihi =[
"Saladin", #firstname
"Tuahihi", #lastname
"The bun",#nickname
